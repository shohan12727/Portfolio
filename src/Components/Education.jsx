            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center mr-8 md:mr-12">
                  <div
                    className={`w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg transition-transform group-hover:scale-110 ${status.circle}`}
                  >
                    {item.status === "current" ? (
                  ...
                  {index !== educationData.length - 1 && (
                    <div className="w-1 flex-1 my-3 bg-gradient-to-b from-orange-500 via-blue-500 to-blue-900 rounded-full" />
                  )}
                </div>

                {/* Card */}
                <div className="pb-14 flex-1">
                  <div className="bg-white/80 backdrop-blur rounded-2xl p-6 md:p-8 shadow-lg border border-gray-100 transition-all hover:-translate-y-1 hover:shadow-2xl">
                    <span
